<script lang="ts">
	import { ShieldCheck, Lock, FileCheck } from 'lucide-svelte';
</script>

<section class="max-w-[1200px] mx-auto px-6 py-20 border-t border-gray-100">
	<div class="flex flex-col md:flex-row items-center justify-between gap-12">
		<div class="max-w-xl">
			<h2 class="text-3xl font-serif text-gray-900 mb-4">
				Enterprise-grade security. <span class="text-gray-500 font-sans text-lg font-normal">Hivebuy is audited and certified by industry-leading third party standards, meeting German data protection requirements.</span>
			</h2>
